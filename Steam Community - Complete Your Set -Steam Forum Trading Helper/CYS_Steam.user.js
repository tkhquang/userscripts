...
// ==Configuration==
const AugmentedSteam = false; //Set to true if you have Enhanced Steam or Augmented Steam installed, so that the button won't be overlapped
                    ...
                    if (remainSet) {
                        ...
                        if (fullSetUnowned) {
                            ...
                            if (remainCards(numSet) !== info.set && info.qtyDiff) {
                                ...
                                console.log((info.qtyDiff) ? "Your cards are enough to get a full set" : "You need a whole full set");
                            }
                        } else {
                            numSet = Math.floor(setDiff);
